...
class ViewMvcFactory(inflater : LayoutInflater) {
    ...
    fun getAuthenticationViewMvc(@Nullable parent: ViewGroup?, neuraManager : NeuraHelper) : AuthenticationViewMvc {
        return AuthenticationViewMvcImpl(mLayoutInflater, parent, neuraManager)
    }
}